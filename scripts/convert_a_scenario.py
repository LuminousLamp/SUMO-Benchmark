...
scenario_list = read_data(
    "/media/led/LED-WD1T/WOMD/validation/validation.tfrecord-00000-of-00150",
)
...
for i, scenario in enumerate(scenario_list):
    ...
    waymo2sumo.plot_sumonic_map(base_dir=".", filename=f"{scenario.scenario_id}.png")
    # 2. save the .net.xml file
    waymo2sumo.save_SUMO_netfile(base_dir=".", filename=f"{scenario.scenario_id}.net.xml")
